...
M.highlights_base = function (colors)
  return {
    ...
    WarningMsg = { fg = colors.color13, bg = colors.background },
    DiffAdd = { fg = colors.background, bg = colors.color15 },
    DiffChange = { fg = colors.background, bg = colors.color15 },
    DiffDelete = { fg = colors.background, bg = colors.color15 },
    ...
    ErrorMsg = { fg = colors.color14, bg = colors.background },
    ...
    Variable = { fg = colors.color0 },
    String = { fg = colors.color4 },
    Character = { fg = colors.color4 },
    Constant = { fg = colors.color0 },
    Number = { fg = colors.color2 },
    Boolean = { fg = colors.color9 },
    Float = { fg = colors.color2 },
    Identifier = { fg = colors.color0 },
    Function = { fg = colors.color0 },
    Operator = { fg = colors.color2 },
